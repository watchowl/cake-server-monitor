...
class DiskSpace extends CommandDefinition
{
    ...
    {
        return sprintf('Current disk space usage is safe at %', $this->currentUsagePercentage);
    }
    ...
    {
        return sprintf('Disk space usage is more than %', $this->currentUsagePercentage);
    }
